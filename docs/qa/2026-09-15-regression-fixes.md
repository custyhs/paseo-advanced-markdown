...
| `\textbf{中文}` was rejected by the SVG attribute validator | `tests/math-render.test.ts`: plain and bold Chinese both render, with different PNGs |
...
- `npx vitest run tests/math-render.test.ts --bail=1`: 11 tests passed.
